...
const Footer: React.FC = () => {
  return (
    <footer className="bg-blue-50 pt-10 pb-6">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* Logo and About */}
          <div className="md:col-span-1">
            <div className="flex items-center mb-4">
              <School className="text-blue-600 h-6 w-6 mr-2" />
              <h3 className="text-blue-600 font-bold text-lg">STAR Educational Trust</h3>
            </div>
          ...
          <div className="md:col-span-1">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/facility" className="text-gray-600 hover:text-blue-600 transition-colors">
                  Our Facility
                </Link>
              </li>
              <li>
                <Link to="/activities" className="text-gray-600 hover:text-blue-600 transition-colors">
          ...
          <div className="md:col-span-1">
            ...
            <div className="space-y-3">
              <div className="flex items-start">
                <Phone className="text-blue-500 h-5 w-5 mr-2 mt-1" />
                <div>
              ...
              <div className="flex items-start">
                <Mail className="text-blue-500 h-5 w-5 mr-2 mt-1" />
                <p className="text-gray-600">info@stareducationaltrust.in</p>
              </div>
              <div className="flex items-start">
                <MapPin className="text-blue-500 h-5 w-5 mr-2 mt-1" />
